...
public class TimedLaunchCommand extends CommandBase {
  /** Creates a new TimedLaunchCommand - runs launcher for x milliseconds.*/
  long endTime;
  long startTime;

  public TimedLaunchCommand(long time) {
